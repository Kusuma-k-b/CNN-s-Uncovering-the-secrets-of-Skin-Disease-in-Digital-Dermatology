...
meta=pd.read_csv('F:/Documents/CodeTest/Skin-Disease-Prediction-Web-Application-master/HAM10000_metadata.csv')
print(meta.info())
print(meta.head())
...
df=pd.read_csv('F:/Documents/CodeTest/Skin-Disease-Prediction-Web-Application-master/hmnist_28_28_RGB.csv')
